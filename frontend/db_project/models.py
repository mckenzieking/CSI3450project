...
class AdminHasCustomer(models.Model):
    ...
    customer_menu_menu_item = models.ForeignKey('Customer', models.DO_NOTHING, db_column='CUSTOMER_MENU_MENU_ITEM_ID')  # Field name made lowercase.
    customer_menu_admin_admin = models.ForeignKey('Customer', models.DO_NOTHING, db_column='CUSTOMER_MENU_ADMIN_ADMIN_ID')  # Field name made lowercase.
